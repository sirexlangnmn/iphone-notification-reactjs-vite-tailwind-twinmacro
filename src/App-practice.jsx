      ...
      <div className="grid min-h-screen bg-purple-50 place-items-center">
        ...
        <div className="mx-auto h-[712px] w-[350px] bg-black rounded-[60px] border-[14px] border-black relative overflow-hidden ring ring-purple-400 shadow-xl">
          ...
          <div className="absolute top-0 inset-x-0">
            <div className="mx-auto bg-black h-6 w-40 rounded-b-3xl" />
          </div>
          <div className="relative">
            ...
            <div className="relative mt-4 mx-2">
              ...
              <div className="absolute -bottom-4 scale-[0.85] origin-bottom inset-x-0 h-full w-full bg-white/10 backdrop-blur-md rounded-2xl" />
              <div className="absolute -bottom-2 scale-95 origin-bottom inset-x-0 h-full w-full bg-white/30 backdrop-blur-md rounded-3xl shadow-sm" />
              {/* Main, current panel */}
              <div className="p-4 bg-white/40 backdrop-blur-md rounded-3xl shadow">
                ...
                <div className="mt-2 grid grid-cols-2 gap-2">
                  <div>
                    <img className="rounded-lg h-24 w-full object-cover" src="https://images.unsplash.com/photo-1588974269162-4c0d5ccc6094?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=3302&q=80" alt="Surfer at sunset" />
                  ...
                  <div>
                    <img className="rounded-lg h-24 w-full object-cover" src="https://media.bleacherreport.com/image/upload/v1625368217/ilertc3nqs53klcp9xvx.jpg" alt="CP3 vs the Greek Freak" />
                ...
                <div className="mt-3 grid grid-cols-3 items-end">
                  ...
                  <ul className="flex -space-x-4 flex-row-reverse space-x-reverse">
                    ...
                    <li>
                      <img className="h-8 w-8 rounded-xl object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEZUAlsS1loKxsx8abFEgwSi5KBus3tmsQaA&usqp=CAU" alt="" />
                    </li>
                    <li>
                      <img className="h-8 w-8 rounded-xl object-cover" src="https://www.engmanagement.dev/_next/image?url=%2F_next%2Fstatic%2Fimage%2Fpublic%2Fimages%2Fsarah-drasner%402x.fa3f0a5d32f918fbe0918080d2767ad7.jpg&w=384&q=95" alt="" />
                    </li>
                  </ul>
                </div>
              </div>
